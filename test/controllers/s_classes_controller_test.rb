...
class SClassesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create s_class" do
    assert_difference('SClass.count') do
      post s_classes_url, params: { s_class: { class_id: @s_class.class_id, name: @s_class.name } }
    end
  ...
  test "should update s_class" do
    patch s_class_url(@s_class), params: { s_class: { class_id: @s_class.class_id, name: @s_class.name } }
